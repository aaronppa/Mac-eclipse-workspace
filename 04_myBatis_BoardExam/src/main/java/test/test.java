...
public class test {
	...
	public static void mailSender() throws AddressException, MessagingException {
		...
		final String username = "haedoang"; // 네이버 아이디를 입력해주세요. @nave.com은 입력하지 마시구요.
		final String password = "qpwoei23@#"; // 네이버 이메일 비밀번호를 입력해주세요.
		int port = 465; // 포트번호 // 메일 내용
		String recipient = "dq0318@naver.com"; // 받는 사람의 메일주소를 입력해주세요.
		...
		// MimeMessage 생성
		mimeMessage.setFrom(new InternetAddress("haedoang@naver.com"));
